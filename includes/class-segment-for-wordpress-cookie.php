...
/**
 * Below (from line 14) are the notes from the original Segment plugin. It's an interesting way to solve the issue described.
 *
 * One of the big problems I found was events getting double counted because the Segment Cookie wasn't being cleared via AJAX.
 *
 * The current solution is to first try to clear the cookies with AJAX, but have a js script that checks for any stray cookies
 * and makes sure they're deleted before the next page loads, so no double events.
 *
 *
 *
 *
